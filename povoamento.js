...
db.artists.insertMany([
	...
	},
	{
		...
		festivals: [db.festivals.findOne({ name: "The Town" })],
		schedule: {
			day: new Date("2023-09-02"),
			stage: db.stages.findOne({ name: "Skyline" }),
		},
	...
	},
	{
		...
		festivals: [db.festivals.findOne({ name: "Lollapalooza" })],
		schedule: {
	...
	},
	{
		...
		festivals: [db.festivals.findOne({ name: "Primavera Sound" })],
		schedule: {
			day: new Date("2022-11-05"),
	...
	},
	{
		...
		festivals: [db.festivals.findOne({ name: "Coachella" })],
		schedule: {
